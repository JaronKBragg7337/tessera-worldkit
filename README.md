...
![Assets](https://img.shields.io/badge/assets-12-informational)
...
**Twelve original parts** (`kits/shell_v1/parts.py`): foundation pad, floor
slab, straight wall, L corner, doorway wall, door leaf, window wall, glazed
window leaf, pitched roof panel, ridge cap, crate, workbench. Every one is
generated by script; no third-party asset is read at any point.
...
supported without an executable path.
...
**Collision that seals the doorway.** Auto-generated convex hulls close
doorways, arches and stairs. Tessera never generates collision: the occupancy
