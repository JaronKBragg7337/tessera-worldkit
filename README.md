...
**Twenty-two original parts** (`kits/shell_v1/parts.py`): foundation pad, floor
...
interior doorway wall, interior corner, and wall-to-wall junction trim. Every
one is generated by script; no third-party asset is read at any point.
...
| Roads, terrain, fences, gates, signage, lighting | Not in the kit. A 22-part structural kit proves the contract; it is not a content library |
